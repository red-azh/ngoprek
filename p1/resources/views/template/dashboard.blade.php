                ...
                <div class="navbar-nav w-100">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                                class="fa fa-laptop me-2"></i>Warung Kopi</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{route("penjual.index")}}" class="dropdown-item">Penjual</a>
                            <a href="{{route("daftarIsi.index")}}" class="dropdown-item">Daftar Isi</a>
                            <a href="{{route("langganan.index")}}" class="dropdown-item">Langganan</a>
                        </div>
                    </div>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="{{asset('dark')}}/img/user.jpg" alt=""
                                style="width: 40px; height: 40px;">
